...
bash shell Di android sekarang kita bisa menjalankan berbagai macam bahasa pemrograman termasuk program perintah bash shell ini. Untuk menjalankan bash shell di android kalian bisa menggunakan aplikasi terminal emulator, gnu root debian, termux. yang paling populer sekarang adalah termux. 
 ...
 **Keterangan!** Dibagian atas kita mendefinisakn bahwa file yang kita buat adalah script bash. Lalu kode berikutnya kita ingin menampilkan kata hello world sama kayak php untuk menampilkan datanya. 
...
Referensi : [Wikipedia](https://en.wikipedia.org/wiki/Bash_(Unix_shell))
