...
date: '2020-07-08T09:43:25+00:00'
author: 'Jujun Jamaludin'
layout: post
guid: 'https://kumpul4semut.com/?p=459'
permalink: /tutorial-lengkap-crud-codeigniter-4-dan-react-js-4-edit-data/
...
zakra_logo:
    - '0'
image: /wp-content/uploads/2020/08/ci4plusreact-Recovered.jpg
categories:
    - 'codeigniter 4'
    - PHP
    - 'React js'
...
Edit data selalu dibutuhkan dalam sebuah sistem programing. Kali ini kita akan lanjutkan tutorial CRUD codeigniter 4 dengan react js bagian edit data. \[caption id="attachment\_460" align="aligncenter" width="640"\][![Edit data codeigniter 4 react js](https://kumpul4semut.com/wp-content/uploads/2020/07/ci4plusreact-Recovered-1024x590.jpg)](https://kumpul4semut.com/wp-content/uploads/2020/07/ci4plusreact-Recovered.jpg) Edit data codeigniter 4 react js\[/caption\] Setelah sebelumnya dalam [Tutorial Lengkap CRUD Codeigniter 4 dan React js #3 Show Data](https://kumpul4semut.com/tutorial-lengkap-crud-codeigniter-4-dan-react-js-3-show-data/) kita sudah membuat tombol untuk delete dan edit tapi belum berfungsi sebagaimana mestinya. Sekarang mari kita buat tommbol edit ini berfungsi. Langsung saja ya!.
...
#### Method untuk mengambil data yang mau diedit
 ...
 ```
<pre class="lang:default decode:true ">public function edit($id = NULL)
    {
...
#### Method untuk mengupdate data yang sudah diedit
 ...
 ```
<pre class="lang:default decode:true ">public function update($id = NULL)
    {
...
<pre class="lang:default decode:true ">public function getQuotes($id = false)
    {
        if ($id === false) {
            return $this->findAll();
        } else {
...
```
 ...
 Selesai kita membuat rest apinya dengan codeigniter 4 teman teman bisa coba dulu di postman dengan url . - Ambil data yang madu diedit ```
  <pre class="lang:default decode:true "> http://localhost:8080/quotes/id/edit
...
<pre class="lang:default decode:true ">constructor(props) {
    super(props);
    this.state = {
      listquotes: [],
      quotes: "",
...
<pre class="lang:default decode:true">                {this.state.isEdit ? (
                  <div>
                    <input
...
```
 ...
 ```
<pre class="lang:default decode:true ">edit(id) {
...
```
 ...
 Hasilnya seperti ini [![](https://kumpul4semut.com/wp-content/uploads/2020/07/createci4reactjsedit.gif)](https://kumpul4semut.com/wp-content/uploads/2020/07/createci4reactjsedit.gif)