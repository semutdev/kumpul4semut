...
date: '2019-06-15T02:16:45+00:00'
author: 'Jujun Jamaludin'
layout: post
guid: 'https://www.kumpul4semut.com/?p=188'
permalink: /belajar-tipe-data-dan-variabel-python/
...
zakra_logo:
    - '0'
image: /wp-content/uploads/2019/06/20190615_090159-1.png
categories:
    - Python
tags:
...
> \[caption id="attachment\_197" align="aligncenter" width="640"\][![tipe data dan variabel python](https://www.kumpul4semut.com/wp-content/uploads/2019/06/20190615_090159-1024x576.png)](https://www.kumpul4semut.com/wp-content/uploads/2019/06/20190615_090159.png) Tipe Data dan Variabel Python\[/caption\]
...
<pre class="lang:default decode:true ">Nama_Variabel = [Nilainya]
```
...
```
 ...
 Maka termuxnya akan berubah menjadi: [![python termux](https://www.kumpul4semut.com/wp-content/uploads/2019/06/20190615_091119-1024x576.png)](https://www.kumpul4semut.com/wp-content/uploads/2019/06/20190615_091119.png)### Membuat variabel python di termux

 Contohnya: ```
<pre class="lang:default decode:true">variabel = "ini isinya"
```
...
<pre class="lang:default decode:true">>>>print(variabel)
ini isinya
>>>
```
...
<pre class="lang:default decode:true ">python [nama_file.py]
```

 Jika mengambil dari contoh akan menjadi: ```
<pre class="lang:default decode:true ">$ python test.py
ini isinya
```
...
<pre class="lang:default decode:true">nama = "Jujun Jamaludin"
...
<pre class="lang:default decode:true ">panjang=350 #bilangan bulat
...
<pre class="lang:default decode:true ">benar = true
